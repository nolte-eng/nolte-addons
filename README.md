# Nolte Odoo Addons – Odoo 18

Dieser Branch enthält die für Odoo 18 gepflegten Nolte-Zusatzmodule.

## Branch-Regel

Für Odoo 18 ausschließlich den Branch `18.0` verwenden. Änderungen werden über einen eigenen Arbeitsbranch und Pull Request eingebracht. Direkte Änderungen auf dem Server sollten vermieden werden.
...
```bash
cd ~/addons/18.0/nolte-addons
git fetch origin
git checkout 18.0
git pull --ff-only origin 18.0
```
